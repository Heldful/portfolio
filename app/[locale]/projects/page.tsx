...
const ProjectsPage = async ({
  ...
  const views = (
    ...
    acc[localizedProjects[i].slug] = v ?? 0;
    return acc;
  ...
  const top3 = localizedProjects.find(
    (project) => project.slug === "highstorm"
  )!;
  const sorted = localizedProjects
  ...
  return (
    <div className="relative pb-16">
      <Navigation locale={locale} links={links} />
      <div className="px-6 pt-20 mx-auto space-y-8 max-w-7xl lg:px-8 md:space-y-16 md:pt-24 lg:pt-32">
        ...
        <div className="grid grid-cols-1 gap-8 mx-auto lg:grid-cols-2 ">
          <Card>
            <Link href={`${routes.Projects}/${featured.slug}`}>
